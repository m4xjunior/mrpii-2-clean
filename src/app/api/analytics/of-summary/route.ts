...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`🔍 Buscando dados consolidados da OF ${cod_of}...`);
    ...
    logger.info('🔍 Buscando dados básicos da OF (query pesada)...');
    ...
    logger.info('🔍 Calculando tempos e velocidade...');
    ...
    logger.error('❌ Erro ao buscar dados da OF:', error);
    return NextResponse.json({
      success: false,
